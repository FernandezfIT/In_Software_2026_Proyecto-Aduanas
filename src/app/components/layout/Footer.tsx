...
export function Footer() {
  return (
    <footer style={{ backgroundColor: C.tertiary, color: C.accent, padding: '20px 32px' }}>
      ...
      <div style={{ marginTop: '12px', paddingTop: '12px', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', justifyContent: 'space-between', fontSize: '11px' }}>
        <span>© 2026 Servicio Nacional de Aduanas. Todos los derechos reservados.</span>
        <span style={{ backgroundColor: 'rgba(255,255,255,0.15)', padding: '2px 10px', borderRadius: '4px', color: C.white }}>
          Prototipo v1.0 · EV3
        </span>
      </div>
    </footer>
