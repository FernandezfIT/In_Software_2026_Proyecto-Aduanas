...
const HERO_URL = 'https://images.unsplash.com/photo-1765223085093-3e75a2f19b73?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=1400';
...
export function HomePage({ navigate, currentUser, logout }: NavProps) {
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <button
              ...
              style={{
                ...
                boxShadow: '0 4px 16px rgba(0,111,179,0.5)',
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                border: `2px solid rgba(255,255,255,0.6)`, padding: '12px 28px', borderRadius: '8px',
                fontSize: '15px', fontWeight: 600, cursor: 'pointer',
              }}
            >
      ...
      {/* Info Cards */}
      <section style={{ padding: '48px 32px', backgroundColor: C.bgPage ?? '#F0F2F5' }}>
          ...
          {INFO_CARDS.map((card) => {
            ...
            return (
              <div key={card.title} style={{
                ...
                <h3 style={{ fontSize: '15px', fontWeight: 700, color: C.tertiary, marginBottom: '8px' }}>
                  {card.title}
                </h3>
            ...
            {[
              ...
              return (
                <div key={item.label} style={{
                  ...
                  <Icon size={22} color={C.accent} style={{ flexShrink: 0, marginTop: '2px' }} />
                  <div>
                    <div style={{ fontSize: '11px', color: C.accent, marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      {item.label}
                    </div>
